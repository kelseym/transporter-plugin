...
(function(factory){
    ...
    function viewHistoryDialog(e, onclose) {
        ...
        XNAT.plugin.transporter.activityTable.viewHistory(activityId);
    }
    ...
    const labelMap = {
        ...
        username:       {label: 'Run As User', column: 'username', show: true},
        snapshotId:   {label: 'Snapshot', column: 'snapshotId', show: true},
    ...
    function activityTableObject() {
        return {
            table: {
                ...
                style: "width: auto;",
                on: [
                    ['click', 'a.view-container-activity', viewHistoryDialog]
                ]
            },
            before: {
                filterCss: {
            ...
            filter: 'sessionId, username, snapshotId, status',
            items: {
                // id: {
                //     th: {className: 'id'},
    ...
    activityTable.viewHistory = function (id) {
